...
if [ $choice -eq 1 ] ; then
	...
	curl -L https://github.com/Midnight-Myth/NadekoBot-BashScript/raw/ash/nadeko_installer_latest.sh | sh
	echo ""
	...
	if [ $choice -eq 2 ] ; then
		echo ""
		echo "Downloading NadekoBot, please wait."
		curl -L https://github.com/Midnight-Myth/NadekoBot-BashScript/raw/ash/nadeko_installer.sh | sh
		echo ""
		...
		if [ $choice -eq 3 ] ; then
			...
			curl -L https://github.com/Midnight-Myth/NadekoBot-BashScript/raw/ash/nadeko_run.sh | sh
			echo ""
			...
			if [ $choice -eq 4 ] ; then
				...
				sleep 5s
				wget -N https://github.com/Midnight-Myth/NadekoBot-BashScript/raw/ash/NadekoAutoRestartAndUpdate.sh && bash NadekoAutoRestartAndUpdate.sh
				echo ""
